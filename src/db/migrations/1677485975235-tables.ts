...
export class tables1677485975235 implements MigrationInterface {
    name = 'tables1677485975235'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "favs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "artists" text NOT NULL, "albums" text NOT NULL, "tracks" text NOT NULL, CONSTRAINT "PK_2fde25c80bd089c0fa0e7986409" PRIMARY KEY ("id"))`);
